# -*- coding: utf-8 -*-
"""
Created on Fri Mar 18 20:35:30 2022
...
end1 = time.time()
print("RANSAC running time: ", end1 - start1)

#residual plots analyzation for RANSAC
...
print('R^2 train: %.3f, test: %.3f' % (score_train, score_test))
...
end2 = time.time()
print("ridge running time: ", end2-start2)

# LASSO regression:
start3 = time.time()
lasso = Lasso(alpha=1.0)
end3 = time.time()
print("lasso running time: ", end3-start3)
