...
and random forest using Mammographic Mass dataset
'''


# input Mammographic Mass Classification
...
print("Following values are tested with Mammographic Mass Data set")
print('')
